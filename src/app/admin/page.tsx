...
import { CaretRight, CirclesFour, MagnifyingGlass, PlusCircle, Sparkle } from '@phosphor-icons/react/dist/ssr';
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto w-full animate-slick-reveal">
      <div className="flex justify-between items-end mb-10">
        <div>
          <h2 className="text-4xl font-black italic uppercase text-slate-800 leading-none">Product Inventory</h2>
          <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mt-3">Select a model to manage interactive hotspots and media</p>
        </div>
        <div className="hidden md:flex bg-white border-2 border-slate-100 rounded-2xl px-6 py-3 items-center gap-3 shadow-sm focus-within:border-marquis-blue transition-all">
